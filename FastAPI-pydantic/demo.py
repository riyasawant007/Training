...
app = FastAPI()         #creates an instance
...
items = {
    ...
    1: Item(name="Pliers", price=5.99, count=20, id=2, category=Category.TOOLS), 
...
def delete_item(item_id: int) -> dict[str, Item]:
    ...
    if item_id not in items:
        raise HTTPException(
            status_code=400, detail=f"Item with {item_id=} already exists."
            )
